...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertItem() {
        ...
        // and the item Apple's attributes are the values.
        ContentValues values = new ContentValues();
        values.put(ItemContract.ItemEntry.COLUMN_ITEM_NAME, "Apple");
        values.put(ItemContract.ItemEntry.COLUMN_ITEM_TYPE, ItemContract.ItemEntry.TYPE_FOOD);
        values.put(ItemEntry.COLUMN_ITEM_PRICE, 1);
        values.put(ItemEntry.COLUMN_ITEM_QUANTITY, 2);

        // Insert a new row for Apple into the provider using the ContentResolver.
        // Use the {@link ItemEntry#CONTENT_URI} to indicate that we want to insert
        // into the items database table.
        // Receive the new content URI that will allow us to access Apple's data in the future.
