...
/**
 * {@link ContentProvider} for Shelf app.
 */
public class ItemProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.shelf/shelf" will map to the
        ...
        // For example, "content://com.example.android.shelf/shelf/3" matches, but
        // "content://com.example.android.shelf/shelf" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.example.android.shelf/shelf/3",
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        Integer type = values.getAsInteger(ItemContract.ItemEntry.COLUMN_ITEM_TYPE);
        if (type == null || !ItemContract.ItemEntry.isValidType(type)) {
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ItemEntry.COLUMN_ITEM_TYPE)) {
            Integer gender = values.getAsInteger(ItemContract.ItemEntry.COLUMN_ITEM_TYPE);
            if (gender == null || !ItemContract.ItemEntry.isValidType(gender)) {
                throw new IllegalArgumentException("Item requires valid type");
            }
        }
        ...
        if (values.containsKey(ItemContract.ItemEntry.COLUMN_ITEM_QUANTITY)) {
            // Check that the quantity is greater than or equal to 0 items
            Integer quantity = values.getAsInteger(ItemContract.ItemEntry.COLUMN_ITEM_QUANTITY);
            if (quantity != null && quantity < 0) {
                throw new IllegalArgumentException("Item requires valid quantity");
            }
